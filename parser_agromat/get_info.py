...
class GetInfoGeneralPage:
    @staticmethod
    def get_main_tags_a(bs4_obj) -> object | str:
    ...
    @staticmethod
    def get_href_individual_page(main_address, bs4_obj):
...
class GetInfoIndividualPage:
    @staticmethod
    def get_main_tag(bs4_obj):  # div : class - product-main
        return bs4_obj.find('div', {'class': 'product-main'})

    @staticmethod
    def get_name(bs4_obj):
        return bs4_obj.find('div', {'id': 'main-info'}).find('h1').text

    @staticmethod
    def get_discount(bs4_obj):
        try:
